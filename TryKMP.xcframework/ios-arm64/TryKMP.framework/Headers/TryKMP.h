...
@class NSDate, TKMPGitHubRepo, TKMPGitHubRepoItem, TKMPKotlinArray<T>, TKMPKotlinException, TKMPKotlinIllegalStateException, TKMPKotlinRuntimeException, TKMPKotlinThrowable, TKMPTryKmpCommon;
...
__attribute__((swift_name("TryKmpCommon")))
@interface TKMPTryKmpCommon : TKMPBase
...
@interface TKMPTryKmp : TKMPTryKmpCommon
...
*/
- (void)searchGitHubRepoQuery:(NSString *)query completionHandler:(void (^)(TKMPGitHubRepo * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("searchGitHubRepo(query:completionHandler:)")));
...
@interface TKMPGitHubRepo : TKMPBase
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) BOOL incompleteResults __attribute__((swift_name("incompleteResults")));
@property (readonly) NSArray<TKMPGitHubRepoItem *> *items __attribute__((swift_name("items")));
@property (readonly) int32_t totalCount __attribute__((swift_name("totalCount")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("GitHubRepoItem")))
@interface TKMPGitHubRepoItem : TKMPBase
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
@property (readonly) NSDate *updatedAt __attribute__((swift_name("updatedAt")));
